REM All the graphs for running the two versions of HEVC/H.265
REM with the neural networks for intra prediction are frozen.
...
REM `is_pair` means that the PNN models were trained on
REM contexts with HEVC quantization noise.
